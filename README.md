# healthchecks-docker [![Build Status](https://drone.craftingit.de/api/badges/CraftingITde/healthchecks-docker/status.svg)](https://drone.craftingit.de/CraftingITde/healthchecks-docker)
